...
class TarjetaComunicadoCliente extends StatefulWidget {
  ...
  TarjetaComunicadoCliente(
      {this.comunicadoModel, List<ComunicadoModel>? comunicadoProvider});
}
  ...
  condicionComunicados(context, _screenSize) {
    if (widget.comunicadoModel!.length == 0) {
      ...
      return SmartRefresher(
          ...
          child: _conComunicadoCliente());
    }
  }

  Widget _conComunicadoCliente() {
    final _screenSize = MediaQuery.of(context).size;
    if (widget.comunicadoModel!.length == 0) {
      return Center(
          child: Padding(
            ...
            return Container(
              ...
              child: Column(
                children: <Widget>[
                  GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, '/homeClienteDetalle',
                            arguments: widget.comunicadoModel![index]);
                      },
                      child: Hero(
                        tag: widget.comunicadoModel![index].comunicadoIdCliente
                            .toString(),
                        child: SingleChildScrollView(
                          child: ClipRRect(
