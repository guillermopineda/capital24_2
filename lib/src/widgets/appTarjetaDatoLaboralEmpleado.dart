...
class AppTarjetaDatoLaboralEmpleado extends StatelessWidget {
                  ...
                  Column(
                      ...
                      children: <Widget>[
                        ListTile(
                            ...
                            title: Text(
                                "datoLaboralEmpleadoModel.numeroEmpleado.toString()??"
                                "")),
                        ListTile(
                            subtitle: Text(
                              "Compañia",
                            ...
                            title:
                                Text("datoLaboralEmpleadoModel.nombreCompania??"
                                    "")),
                        ListTile(
                            subtitle: Text(
                              "Proyecto Principal",
                        ...
                        ListTile(
                            ...
                            title:
                                Text("datoLaboralEmpleadoModel.declaracionImp??"
                                    "")),
                        ListTile(
                            subtitle: Text(
                              "Servicio",
  ...
  getDatoSueldo() {
    ...
    // if (datoLaboralEmpleadoModel.sueldo >= 50.0)
    if (51 >= 50.0)
      return ListTile(
          subtitle: Text(
            "Sueldo",
