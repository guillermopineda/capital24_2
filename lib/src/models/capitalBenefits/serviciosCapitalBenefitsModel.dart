...
List<TduServicios> tduServiciosFromJson(String str) => List<TduServicios>.from(
    json.decode(str).map((x) => TduServicios.fromJson(x)));
...
class TduServicios {
  ...
  factory TduServicios.fromJson(Map<String, dynamic> json) => TduServicios(
...
enum TiporedencionNombre { TARJETA_DIGITAL, LINK }
